...
def get_shear_center(h,c,Izz,t):
    ...
    qb21int=integrate.dblquad(lambda s, s4: 1/Izz*t*(r-s4), 0, r, lambda s:0, lambda s: s)
    qbint2=2*(qb21int[0])+2*qb52int[0]
    ...
    spar_mom=(c-r)*(2*qb21int[0]+qs0II-2*qb12int[0]-qs0I)
